...
public class TestHelpper {
    ...
    /** Global test scanner         */
    public comtest.java.ComTestScanner scanner;

    /** Global test codeHandler     */
    public comtest.java.ComTestScanner.CommentCodeHandler codeHandler;
    ...
    public TestHelpper() {
      ...
      scanner = new comtest.java.ComTestScanner(new ComTestIni(), contents);
